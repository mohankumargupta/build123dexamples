...
def run(context):
    try:
        ...
        centerPoint = sketch.sketchPoints.item(7)
        dim1 = sketch.sketchDimensions.addDistanceDimension(
            sketch.originPoint,
            centerPoint,
            adsk.fusion.DimensionOrientations.HorizontalDimensionOrientation,
            adsk.core.Point3D.create(centerPoint.geometry.x / 2, centerPoint.geometry.y , 0)  # Position of the dimension text
        )
        dim1.value = (length-x_offset)/10
        dim2 = sketch.sketchDimensions.addDistanceDimension(
            sketch.originPoint,
            centerPoint,
            adsk.fusion.DimensionOrientations.VerticalDimensionOrientation,
            adsk.core.Point3D.create(centerPoint.geometry.x, centerPoint.geometry.y , 0)  # Position of the dimension text
        )
        dim2.value = (y2_offset)/10        
